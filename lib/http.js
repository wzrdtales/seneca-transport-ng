...
exports.listen = function (options, transportUtil) {
  return function (msg, callback) {
    ...
    server.on('listening', function () {
      listenDetails.port = server.address().port;
      seneca.log.debug('listen', listenDetails);
      callback(null, listenDetails);
    });

    function listen () {
      listener = server.listen(
        (listenDetails.port = transportUtil.resolveDynamicValue(
          listenOptions.port,
          listenOptions
        )),
        (listenDetails.host = transportUtil.resolveDynamicValue(
          listenOptions.host,
          listenOptions
        ))
      );
...
exports.client = function (options, transportUtil) {
  return function (msg, callback) {
    ...
    var send = function (spec, topic, sendDone) {
